                        ...
                        <div className="card-body">
                            <div className="inovices-widget-header">
                                ...
                                <div className="inovices-dash-count">
                                    <div className="inovices-amount">$378,797</div>
                                </div>
                            </div>
                    ...
                    <div className="card inovices-card">
                        <div className="card-body">
                            <div className="inovices-widget-header">
                                ...
                                <div className="inovices-dash-count">
                                    <div className="inovices-amount">$323,584</div>
                                </div>
                            </div>
                    ...
                    <div className="card inovices-card">
                        <div className="card-body">
                            <div className="inovices-widget-header">
                                ...
                                <div className="inovices-dash-count">
                                    <div className="inovices-amount">$45,545</div>
                                </div>
                            </div>
                    ...
                    <div className="card inovices-card">
                        <div className="card-body">
                            <div className="inovices-widget-header">
                                ...
                                <div className="inovices-dash-count">
                                    <div className="inovices-amount">$5,797</div>
                                </div>
                            </div>
