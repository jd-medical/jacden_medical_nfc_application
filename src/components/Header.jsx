        ...
        <ul className="nav user-menu float-end">
                      ...
                      <span className="avatar">V</span>
                        <div className="media-body">
                          <p className="noti-details">
                            <span className="noti-title">Dr.Kurdell Espinosa-Campbell</span> added
                            new update{" "}
                  ...
                  <li className="notification-message">
                    <Link to="/user-activity">
                      <div className="media">
                        ...
                        <div className="media-body">
                          <p className="noti-details">
                            <span className="noti-title">Dr.Kurdell Espinosa-Campbell</span>{" "}
                            added new update{" "}
                            <span className="noti-title">
                              Started New Appointment
                            </span>
                          </p>
                          <p className="noti-time">
                            <span className="notification-time">
                  ...
                  <li className="notification-message">
                    <Link to="activities.html">
                      <div className="media">
                        ...
                        <div className="media-body">
                          <p className="noti-details">
                            <span className="noti-title">Debra Doubtful</span>{" "}
                            has just checked-in{" "}
                            <span className="noti-title">
                              NFC Tap Card
                            </span>
                  ...
                  <li className="notification-message">
                    <Link to="activities.html">
                      <div className="media">
                        ...
                        <div className="media-body">
                          <p className="noti-details">
                          <span className="noti-title">Marvin Mindful</span>{" "}
                            has just checked-in{" "}
                            <span className="noti-title">
                              NFC Tap Card
                            </span>
          ...
          <li className="nav-item dropdown has-arrow user-profile-list">
            ...
            <div className="dropdown-menu">
              ...
              <Link className="dropdown-item" to="/localization">
                Settings
              </Link>
          ...
          <li className="nav-item ">
            <Link to="/localization" className="hasnotifications nav-link">
