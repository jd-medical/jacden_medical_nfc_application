              ...
              <div className="row">
                <div className="col-md-5">
                  <div className="profile-info-left">
                    <h3 className="user-name m-t-0 mb-0">Amanda Admin</h3>
                    <small className="text-muted">Front Desk Admin</small>
                    <div className="staff-id">Employee ID : ADM-0001</div>
                ...
                <div className="col-md-7">
                  <ul className="personal-info">
                    <li>
                      ...
                      <span className="text"><Link to>876-329-6544</Link></span>
                    </li>
                    <li>
                      <span className="title">Email:</span>
                      <span className="text"><Link to>amandaadmin@example.com</Link></span>
                    </li>
                    <li>
                      <span className="title">Birthday:</span>
                      <span className="text">12th June</span>
                    </li>
                    <li>
                      <span className="title">Address:</span>
                      <span className="text">17 Hope Road, Kingston, JA</span>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <div className="experience-content">
                        <div className="timeline-content">
                          ...
                          <div>BS - International Business &amp; Healthcare</div>
                ...
                <div className="experience-box">
                  <ul className="experience-list">
                    <li>
                      ...
                      <div className="experience-content">
                        <div className="timeline-content">
                          <Link to="#/" className="name">Front Desk Admin</Link>
